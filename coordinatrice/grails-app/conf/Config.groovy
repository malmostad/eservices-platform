...
def ENV_VAR = 'COORDINATRICE_CONFIG'
def FILENAME = '/usr/local/etc/coordinatrice/coordinatrice-config.properties'
...
log4j = {
    ...
    error  'org.codehaus.groovy.grails.web.servlet',        // controllers
	   ...
	   // SQL logging (rather costly)
	   //trace 'org.hibernate.type'
	   //debug 'org.hibernate.SQL'

    error 'grails.app.controllers', 'grails.app.services', 'org.motrice.coordinatrice'
}
