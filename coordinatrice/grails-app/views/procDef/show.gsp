...
<html>
  ...
  <body>
	...
	<g:if test="${procDefInst?.uuid}">
	  <li class="fieldcontain">
	    <span id="uuid-label" class="property-label"><g:message code="procDef.uuid.label" default="Uuid" /></span>
	    <span class="property-value" aria-labelledby="uuid-label"><g:fieldValue bean="${procDefInst}" field="uuid"/></span>
	  </li>
	</g:if>
	<g:if test="${procDefInst?.label}">
	  <li class="fieldcontain">
	    <span id="label-label" class="property-label"><g:message code="procDef.label.label" default="Label" /></span>
	    <span class="property-value" aria-labelledby="label-label"><g:fieldValue bean="${procDefInst}" field="label"/></span>
	  </li>
	</g:if>
	<g:if test="${procDefInst?.name}">
	  <li class="fieldcontain">
	    <span id="name-label" class="property-label"><g:message code="procDef.name.label" default="Name" /></span>
	    <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${procDefInst}" field="name"/></span>
	  </li>
	</g:if>
	...
	<g:if test="${procDefInst?.state}">
	  <li class="fieldcontain">
	    ...
	    <span class="property-value" aria-labelledby="state-label"><g:fieldValue bean="${procDefInst}" field="state"/></span>
	  </li>
	</g:if>
	<g:if test="${procDefInst?.deployedMillis}">
	  <li class="fieldcontain">
	    <span id="deployedMillis-label" class="property-label"><g:message code="procDef.deployedTime.label" default="Deployed" /></span>
	    <span class="property-value" aria-labelledby="deployedMillis-label"><g:fieldValue bean="${procDefInst}" field="deployedTime"/></span>
	  </li>
	</g:if>
	<g:if test="${procDefInst?.undeployedMillis}">
	  <li class="fieldcontain">
	    <span id="undeployedMillis-label" class="property-label"><g:message code="procDef.undeployedTime.label" default="Undeployed" /></span>
	    <span class="property-value" aria-labelledby="undeployedMillis-label"><g:fieldValue bean="${procDefInst}" field="undeployedTime"/></span>
	  </li>
	</g:if>
	...
	<li class="fieldcontain">
	  ...
	  <g:if test="${procDefInst?.startForms}">
		...
		<g:link class="edit" action="edit" id="${procDefInst?.id}">
	...
	<g:if test="${procDefInst?.activities}">
	  <li class="fieldcontain">
	    ...
	    <g:each in="${procDefInst.activities}" var="a">
		  ...
		  <td><g:link controller="actDef" action="show" id="${a.id}">${a?.encodeAsHTML()}</g:link></td>
