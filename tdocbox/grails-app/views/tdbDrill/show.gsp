  ...
  <body>
	...
	<g:if test="${tdbDrillObj?.verb}">
	  <li class="fieldcontain">
	    ...
	    <span class="property-value" aria-labelledby="verb-label">${tdbDrillObj?.verb?.encodeAsHTML()}</span>
	  </li>
	</g:if>
	...
	<g:if test="${tdbDrillObj?.queryString}">
	  <li class="fieldcontain">
	    <span id="queryString-label" class="property-label"><g:message code="tdbDrill.queryString.label" default="Query String" /></span>
