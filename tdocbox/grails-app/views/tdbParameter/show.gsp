...
<html>
  ...
  <body>
	...
	<g:if test="${tdbParameterObj?.b64Encode}">
	  <li class="fieldcontain">
	    <span id="b64Encode-label" class="property-label"><g:message code="tdbParameter.b64Encode.label" default="B64 Encode" /></span>
	    <span class="property-value" aria-labelledby="b64Encode-label"><g:formatBoolean boolean="${tdbParameterObj?.b64Encode}" /></span>
	  </li>
	</g:if>
