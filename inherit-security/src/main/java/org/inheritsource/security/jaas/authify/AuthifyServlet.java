...
public class AuthifyServlet extends HttpServlet {
	...
	public static final String DEFAULT_LANDING_PAGE = ServerConfig.getConfig().getAuthifyLandingPage(); //"http://localhost:8080/citizen/wicket/bookmarkable/org.inheritsource.bonita.citizen.LoginPage";
