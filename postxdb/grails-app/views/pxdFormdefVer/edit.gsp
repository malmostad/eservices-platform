...
<html>
	...
	<body>
		<a href="#edit-pxdFormdefVer" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-pxdFormdefVer" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${pxdFormdefVerObj?.version}" />
				<fieldset class="form">
