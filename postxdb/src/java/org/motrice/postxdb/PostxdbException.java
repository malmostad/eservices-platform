 ...
 */
public class PostxdbException extends RuntimeException {
    // 409 is "Conflict"
    ...
    public PostxdbException(String code, String message) {
	super(message);
	this.code = code;
	http = DEFAULT_HTTP_RESPONSE_CODE;
    }

    public PostxdbException(String code, String message, Throwable cause) {
	super(message, cause);
	this.code = code;
	http = DEFAULT_HTTP_RESPONSE_CODE;
    }
