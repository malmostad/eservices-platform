...
if (CONFPROP1) {
  println "--- DocBox CONFIG: Command line specified ${CONFPROP1}"
  FILENAME = CONFPROP1
} else if (CONFENV1) {
  println "--- DocBox CONFIG: Environment specified ${CONFENV1}"
  FILENAME = CONFENV1
} else if (CONFPROP2) {
  println "--- DocBox CONFIG: Command line specified ${CONFPROP2}"
  FILENAME = CONFPROP2
} else if (CONFENV2) {
  println "--- DocBox CONFIG: Environment specified ${CONFENV2}"
  FILENAME = CONFENV2
} else {
  println "--- DocBox CONFIG: Default ${FILENAME}"
}
