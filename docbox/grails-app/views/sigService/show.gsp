...
<html>
  ...
  <body>
	...
	<g:if test="${sigServiceInst?.alias}">
	  <li class="fieldcontain">
	    <span id="alias-label" class="property-label"><g:message code="sigService.alias.label" default="Alias" /></span>
	    <span class="property-value" aria-labelledby="alias-label"><g:fieldValue bean="${sigServiceInst}" field="alias"/></span>
	  </li>
	</g:if>
	<g:if test="${sigServiceInst?.wsdlLocation}">
	  <li class="fieldcontain">
	    <span id="wsdlLocation-label" class="property-label"><g:message code="sigService.wsdlLocation.label" default="Wsdl Location" /></span>
	...
	<fieldset class="buttons">
	  ...
	  <g:link class="edit" action="check" id="${sigServiceInst?.id}"><g:message code="sigService.check.label" default="Check" /></g:link>
	</fieldset>
      </g:form>
    </div>
  </body>
