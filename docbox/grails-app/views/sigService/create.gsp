...
<html>
  ...
  <body>
    <a href="#create-sigService" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    <div id="create-sigService" class="content scaffold-create" role="main">
