  ...
  <body>
	...
	<g:if test="${sigSchemeObj?.displayName}">
	  <li class="fieldcontain">
	    ...
	    <span class="property-value" aria-labelledby="displayName-label"><g:link controller="sigDisplayname" action="show" id="${sigSchemeObj?.displayName?.id}">${sigSchemeObj?.displayName?.encodeAsHTML()}</g:link></span>
	  </li>
	</g:if>
	<g:if test="${sigSchemeObj?.policy}">
	  <li class="fieldcontain">
	    ...
	    <span class="property-value" aria-labelledby="policy-label"><g:link controller="sigPolicy" action="show" id="${sigSchemeObj?.policy?.id}">${sigSchemeObj?.policy?.encodeAsHTML()}</g:link></span>
	  </li>
	</g:if>
