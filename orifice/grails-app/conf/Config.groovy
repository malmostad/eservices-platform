...
def ENV_VAR = 'ORIFICE_CONFIG'
def FILENAME = '/usr/local/etc/orifice/orifice-config.properties'
...
log4j = {
    ...
    error  'org.codehaus.groovy.grails.web.servlet',        // controllers
	   ...
	   debug 'grails.app.controllers', 'org.motrice.orifice', 'org.motrice.orifice.PackageService'
}
