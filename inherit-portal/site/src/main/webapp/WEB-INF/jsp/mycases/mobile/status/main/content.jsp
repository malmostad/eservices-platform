                ...
                <c:forEach var="item" items="${processInstances}">
                        <li>
                        	<a href="processinstancedetail?processInstanceUuid=${item.processInstanceUuid}">
                                ...
                                <p>
                                        <fmt:message key="mycases.startDate.column.lbl"/>:&nbsp;<fmt:formatDate value="${item.startDate}" type="Date" />
                                </p>
                                <p>
                                        <fmt:message key="mycases.status.column.lbl"/>:&nbsp;${item.status}&nbsp;<fmt:formatDate value="${item.endDate}" type="Date" />
                                </p>
                             </a>
                        </li>
                </c:forEach>
