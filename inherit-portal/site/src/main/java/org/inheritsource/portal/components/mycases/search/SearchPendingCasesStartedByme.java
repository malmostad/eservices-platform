...
public class SearchPendingCasesStartedByme extends BaseSearchCasesComponent {
	...
	public PagedProcessInstanceSearchResult executeSearch(
        ...
        PagedProcessInstanceSearchResult searchResult = engine.searchProcessInstancesStartedByUser(userId, fromIndex, pageSize, sortBy, sortOrder,  "STARTED",  locale, userId);
